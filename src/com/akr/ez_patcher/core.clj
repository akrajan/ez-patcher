  ...
  (let [current-value (Reflector/invokeInstanceMethod obj
    ...
    (let [final-val
          (match [value (obj->class-name value) property-type is-enum-property?]
                 ...
                 [_ _                  'int                 _]   (int value)
                 [_ _                  'byte                _]   (byte value)
                 [_ _                  'short               _]   (short value)
                 [_ _                  'long                _]   (long value)
                 [_ _                  'float               _]   (float value)
                 [_ _                  'double              _]   (double value)
                 [_ _                  'char                _]   (char value)
                 [_ _                  'boolean             _]   (boolean value)
